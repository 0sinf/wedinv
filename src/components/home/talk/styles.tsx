...
export const PartyLabel = styled.label`
	...
	height: 44px;
	border-radius: 8px;
	border: 1px solid rgba(190, 52, 85, 1);
...
export const TalkHeadColors = ["#ECC8F7", "#F7C8D3", "#e5d3b3", "#fed0b0", "#abdaab", "#c8d3f7"]
